...
The idea, then, is to used scraped district spending plans to locate all of the districts that mention "tutor*" in their budget. The map below shows the resulting district locations.

## The map

![[burbio10.png|Map of districts whose ESSER plans mention tutoring]]
