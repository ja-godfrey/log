...
tags:
  ...
  - "#published"
---
[Read it in *The 74 Million* →](https://www.the74million.org/article/new-grants-would-dump-education-money-on-states-with-no-way-to-measure-success/)
...
- [[Why is scaling high-dosage tutoring a measurement problem]] — companion piece on Accelerate
- [[How usable is the federal ESSER expenditure dataset for research]] — the AERA Benford's Law audit
- [[What would an open standard for tutoring data look like]] — the DATAS open standard
- [[If the money moves do the metrics move too]] — earlier piece on the same theme
